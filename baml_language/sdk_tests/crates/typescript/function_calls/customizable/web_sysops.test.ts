...
describe.runIf(isTestRuntime("workers"))("Web fetch sysops", () => {
...
describe.runIf(isTestRuntime("workers"))("Web fs.readFileSync sysop", () => {
...
describe.runIf(isTestRuntime("workers"))("Web capability boundary", () => {
  it("rejects filesystem operations other than read", async () => {
